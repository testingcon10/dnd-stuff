...
- Footnotes reference human trafficking operations - gangs are doing it without using the docks, meaning there is an alternative route into the city that avoids detection
