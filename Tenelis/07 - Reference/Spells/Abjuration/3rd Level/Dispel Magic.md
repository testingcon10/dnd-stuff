...
Choose one creature, object, or magical effect within range. Any spell of [[3rd Level|3rd level]] or lower on the target ends. For each spell of [[4th Level|4th level]] or higher, make an ability check using your spellcasting ability (DC = 10 + the spell's level). On a success, the spell ends.
