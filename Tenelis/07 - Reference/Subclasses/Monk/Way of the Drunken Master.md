...
The Way of the Drunken Master monk moves with the unpredictable sway of a drunkard, turning stumbles into strikes and using erratic movement to avoid harm.
...
- **Intoxicated Frenzy (17th):** When you use Flurry of Blows, you can make up to three additional attacks with it (for a total of five Flurry attacks), provided each attack targets a different creature.
