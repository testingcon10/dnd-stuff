...
**Spell Slot** — A resource expended to cast a spell of [[1st Level|1st level]] or higher. Higher-level slots can cast lower-level spells (often at greater effect). Recovered on a Long Rest (or Short Rest for some classes). See [[Resting]].

**Vulnerability** — If you have Vulnerability to a damage type, damage of that type is **doubled**. See [[Damage Types]].

---
🔗 [Full Details on 5e.tools](https://5e.tools)
